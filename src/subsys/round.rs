...
impl Round {
    pub fn add_turn(&mut self, entity_id: Id, initiative: Initiative) -> ActionResult<()> {
    ...
    pub fn remove_turn(&mut self, entity_id: Id) -> ActionResult<()> {
        if !self.sequence.contains(&entity_id) {
    ...
    pub fn order_turns_by_initiative(&mut self) -> ActionResult<()> {
    ...
    pub fn update_turn_state(&mut self, entity_id: Id, turn_status: TurnStatus) -> ActionResult<()> {
        if !self.sequence.contains(&entity_id) {
    ...
    pub fn next_round(&mut self) -> ActionResult<()> {
    ...
    fn transition_next_round_turn_states(&mut self) -> ActionResult<()> {
